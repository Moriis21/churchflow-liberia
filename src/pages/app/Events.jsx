...
function EventCard({ event, onView, onEdit }) {
  ...
  return (
    <div className="bg-white rounded-2xl border border-slate-100 shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07)] hover:shadow-[0_8px_30px_-5px_rgba(124,58,237,0.12)] hover:-translate-y-0.5 transition-all duration-200 overflow-hidden group">
      {/* Header band */}
      <div className="h-2 w-full bg-gradient-to-r from-[#151022] to-[#5B00B8]" />

      <div className="p-5">
        {/* Top row: status + date chip */}
        <div className="flex items-start justify-between gap-2 mb-4">
          <StatusBadge status={event.status} />
          <div className="flex-shrink-0 w-11 h-11 rounded-xl bg-gradient-to-br from-[#151022] to-[#5B00B8] flex flex-col items-center justify-center text-white shadow-md shadow-purple-500/25">
        ...
        <div className="flex items-start gap-3 mb-4">
          ...
          <div className="flex-1 min-w-0">
            <h3 className="text-sm font-bold text-[#151022] leading-snug line-clamp-2 group-hover:text-purple-700 transition-colors">
              {event.title}
            </h3>
        ...
        <div className="flex items-center gap-2 pt-3 border-t border-slate-50">
          <button
            ...
            className="flex-1 inline-flex items-center justify-center gap-1.5 text-xs font-semibold text-white bg-gradient-to-r from-[#151022] to-[#5B00B8] px-3 py-2 rounded-lg hover:from-[#5B00B8] hover:to-[#3D108A] transition-all shadow-md shadow-purple-500/20"
          >
          ...
          <div>
            ...
            <div className="flex flex-wrap gap-2">
              {volunteers.map((vol, i) => (
                ...
                >
                  <span className="w-5 h-5 rounded-full bg-gradient-to-br from-[#151022] to-[#5B00B8] text-white text-[10px] font-bold flex items-center justify-center">
                    {vol.charAt(0)}
                  </span>
                  {vol}
                </span>
    ...
    <div className="min-h-screen">
      <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-6">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
          {[
            { label: 'Total Events', value: counts.All, color: 'from-[#151022] to-[#5B00B8]', shadow: 'shadow-purple-500/20' },
